...
**AI Engineering · AI Solutions · Enterprise AI Delivery · Overseas Project Experience**
...
- **AI 系统与解决方案**：RAG、知识库问答、Dify Workflow、API 集成与系统分层
- **大模型推理与服务化**：vLLM、Triton Inference Server、TensorRT、ONNX、推理性能与资源效率
- **生成式 AI 工作流**：ComfyUI、文生图工作流、模型服务与业务流程集成
- **平台工程与可观测性**：Docker、Kubernetes、Prometheus、Grafana、服务部署与运行监控
- **企业与海外项目交付**：需求澄清、SOW 理解、PoC、方案协同、部署上线与跨团队沟通

## Tech Stack

| Area | Tools & Technologies |
| --- | --- |
| LLM & AI Applications | RAG, Dify, Transformers, Hugging Face, ComfyUI |
| Inference & Optimization | vLLM, Triton, TensorRT, ONNX, Quantization, Distillation, Pruning |
| Backend & Integration | Python, Flask, REST API, Go |
...
我正在把已有的模型工程基础，进一步沉淀为面向真实业务的 AI 系统能力：
